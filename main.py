...
Bootstrap(app)
#FOR GRAVATAR COMMENT ICON PICTURES
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", form=form, post=requested_post, current_user=current_user, logged_in=current_user.is_authenticated)
